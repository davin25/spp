...
<?php 
 if (isset($_POST['tambah']) ) {
 	...
 	if ($nis == '' || $namasiswa == '' || $kelas ==''){
 		...
 		$simpan = mysqli_query($konek,"INSERT INTO siswa(username,password,nis,namasiswa,kelas,tahunajaran,biaya)
 			VALUES('$user','$p','$nis','$namasiswa','$kelas','$tahunajaran','$biaya')
