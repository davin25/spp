...
<h2 >EDIT DATA SISWA</h2>
 	...
 	<table class="table">
 		...
 		<tr>
 			<td>Username</td>
 			<td>
 				<input type="hidden" name="id" value="<?= $sw['idsiswa'] ?>">
				<input class="form-control" type="text" name="user" value="<?= $sw['username'] ?>">
 			</td>
 		</tr>
 		<tr>
 			<td>Password</td>
 			<td>
 				<input class="form-control" type="Password" id="pass" name="pass" value="<?= $sw['password'] ?>">
